...
function handleMouseOverEvent() {
  outputElement.innerHTML = "You moved your mouse over the Page Title (header)";
}
...
document.getElementById("add-dottedBorder").addEventListener("click", function() {
  guineaPig.classList.toggle("dotted");
})
